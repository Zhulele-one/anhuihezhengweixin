...
public class ZRecruitController {
    ...
    @Autowired
    public ZRecruitController(PageService pageService, FormService formService, TextService textService) {
    ...
    public void init(){
        if(textEntities == null) {
            textEntities = pageService.initPageText(RECRUITID, null);
        }
        if(htmlEntity == null){
    ...
    public ModelAndView recruit(@PathVariable Integer page){
        ...
        ModelAndView mv = new ModelAndView(ZRECRUITTEMPLATE);
    ...
    public ModelAndView seeRecruitForm(@PathVariable Integer page){
        ...
        ModelAndView mv = completeData(pageService,htmlEntity,textEntities,ZFORMLISTTEMPLATE,RECRUITTEXTENTITY,null,false);
    ...
    public SimpleResponse deletePerson(@PathVariable Long id){
        FormEntity personById = formService.findPersonById(id);
        if(personById != null){
            formService.deletePerson(personById);
